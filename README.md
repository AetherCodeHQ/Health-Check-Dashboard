...
**Health Check Dashboard** is a cli tool designed for developers who need fast, reliable, and offline-capable tools. Built with Go for maximum performance and minimal resource usage.
...
```bash
# Basic usage
./Health-Check-Dashboard --path ./target

# With options
./Health-Check-Dashboard --path ./target --format json --output report.json

# Verbose mode
./Health-Check-Dashboard --path ./target --verbose
```
...
### Basic scan
```bash
./Health-Check-Dashboard --path ./my-project
```

### JSON report
```bash
./Health-Check-Dashboard --path ./my-project --format json --output report.json
```

### CI/CD integration
```yaml
# .github/workflows/scan.yml
- name: Run Health Check Dashboard
  run: ./Health-Check-Dashboard --path . --format json --output report.json
```
